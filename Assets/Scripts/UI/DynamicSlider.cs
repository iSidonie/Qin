...
public class DynamicSlider : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
{
    public Slider slider; // 滑动条
    public RectTransform sliderBackground; // 滑动条背景
    public RectTransform sliderHandle; // 滑动条手柄

    public float enlargeHeight = 24f; // 放大后的背景高度
    public float enlargeHandleWidth = 40f; // 放大后的手柄宽度
    public float animationDuration = 1.2f; // 动画持续时间
    ...
    {
        ScrollManager.Instance.ResetUserInteraction();
        Enlarge();
    }
